...
export default function ToolLifecycleRulesWebScreen() {
      ...
      >
        <View className="px-6 py-6">
          <View className="max-w-4xl mx-auto w-full space-y-6">
            {/* Current Tool Lifecycle Rules Table */}
            <View className="bg-white rounded-lg shadow-sm border border-gray-200">
              <View className="px-6 py-4 border-b border-gray-200">
                <Text className="text-xl font-bold text-text-primary">Current Tool Lifecycle Rules</Text>
              </View>
              ...
              {fetchLoading ? (
                ...
                <View className="px-6 py-12 text-center">
                  <Text className="text-text-secondary text-center">No tool lifecycle rules configured</Text>
                </View>
              ) : (
            ...
            {!showAddForm && (
              <View className="flex-row justify-center">
                ...
                >
                  ...
                  >
                    <Text className="text-base font-semibold text-white">Add New Tool Lifecycle Rule</Text>
                  </LinearGradient>
                </TouchableOpacity>
              </View>
            )}
            ...
            {showAddForm && (
              <View className="bg-white rounded-lg shadow-sm border border-gray-200">
                <View className="px-6 py-4 border-b border-gray-200">
                  <Text className="text-xl font-bold text-text-primary">Add New Tool Lifecycle Rule</Text>
                </View>
                ...
                <View className="px-6 py-6 space-y-6">
                  ...
                  {/* 
                    ...
                    - The parent `View` no longer needs `relative`.
                    - The dropdown `View` is rendered conditionally after the button, becoming part of the layout flow.
                    - Removed absolute positioning classes (`absolute`, `top-full`, `z-10`, etc.).
                  */}
                  <View>
