...
export default function ToolShelflifeRulesScreen() {
      ...
      >
        <View className="px-4 py-4">
          <View className="space-y-4">
            {/* Current Tool Shelflife Rules */}
            <View className="bg-white rounded-lg shadow-sm border border-gray-200">
              <View className="px-4 py-3 border-b border-gray-200">
                <Text className="text-base font-bold text-text-primary">Current Tool Shelflife Rules</Text>
              </View>
              ...
              {fetchLoading ? (
                ...
                <View className="px-4 py-8 text-center">
                  <Text className="text-text-secondary text-center text-sm">No tool shelflife rules configured</Text>
                </View>
              ) : (
                <View>
            ...
            {!showAddForm && (
              <View className="flex-row justify-center">
                ...
                >
                  ...
                  >
                    <Text className="text-sm font-semibold text-white">Add New Tool Shelflife Rule</Text>
                  </LinearGradient>
                </TouchableOpacity>
              </View>
            )}
            ...
            {showAddForm && (
              <View className="bg-white rounded-lg shadow-sm border border-gray-200">
                <View className="px-4 py-3 border-b border-gray-200">
                  <Text className="text-base font-bold text-text-primary">Add New Tool Shelflife Rule</Text>
                </View>
